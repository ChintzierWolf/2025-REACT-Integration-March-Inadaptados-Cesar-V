...
description: Esta skill te guía para implementar estrategias de testing efectivas. Cubre testing pyramid, tipos de tests, TDD, BDD, coverage goals, CI/CD integration y mejores prácticas para asegurar calidad del código.
---
