    ...
    <div className="banner-carousel-top">
      ...
      >
        ...
        <div className="banner-carousel-bottom">
          <div className="banner-carousel-bottom-content">
            <h2>Ofertas Especiales</h2>
            <p>Hasta 60% de descuento en títulos seleccionados</p>
            <Button
              variant="primary"
              size="large"
              onClick={() => console.log("Navegando a: /juegos")}
              aria-label="Ver Ofertas - Ofertas Especiales"
            >
              Ver Ofertas
            </Button>
          </div>
